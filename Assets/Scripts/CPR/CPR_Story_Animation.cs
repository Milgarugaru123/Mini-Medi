...
public class CPR_Story_Animation : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (i = 0; i < 20; i++) cut_scene_flags[i] = true;
    }
    ...
    {
        sfx_group.transform.GetChild(4).gameObject.GetComponent<AudioSource>().Play();
    ...
    private IEnumerator WindBlowing()
    {
        sfx_group.transform.GetChild(10).gameObject.GetComponent<AudioSource>().Play();
        yield return new WaitForSeconds(1.5f);
        sfx_group.transform.GetChild(11).gameObject.GetComponent<AudioSource>().Play();
        yield return new WaitForSeconds(4.5f);
        sfx_group.transform.GetChild(10).gameObject.GetComponent<AudioSource>().Stop();
        yield break;
    }

    private IEnumerator Call119()
    {
        sfx_group.transform.GetChild(12).gameObject.GetComponent<AudioSource>().Play();
        yield return new WaitForSeconds(0.3f);
        sfx_group.transform.GetChild(12).gameObject.GetComponent<AudioSource>().Play();
        yield return new WaitForSeconds(0.3f);
        sfx_group.transform.GetChild(13).gameObject.GetComponent<AudioSource>().Play();
        yield break;
    }
    private IEnumerator CallReceived()
    {
        sfx_group.transform.GetChild(14).gameObject.GetComponent<AudioSource>().Play();
        yield return new WaitForSeconds(6.2f);
        sfx_group.transform.GetChild(14).gameObject.GetComponent<AudioSource>().Stop();
        yield return null;
        sfx_group.transform.GetChild(15).gameObject.GetComponent<AudioSource>().Play();
        yield break;
    }
